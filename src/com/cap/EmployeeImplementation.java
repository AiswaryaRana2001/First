...
//        EmployeeImplementation employeeImplementation = new EmployeeImplementation();
//
//        String inputString = "Amit Rai@1PC16CS046-ALU#8";
//        
//        // Extract employee information
//        Employee employee = employeeImplementation.getEmployeeInfo(inputString);
//        System.out.println("Employee Info: " + employee.name + ", " + employee.ssn + ", " + employee.dept + ", " + employee.salary);
//
//        // Get employee department
